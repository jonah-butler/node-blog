  ...
  <div class="container-full site-content">
    <div class="container margin-auto text-center">
      ...
      <p class="max-width-lg margin-auto">A list of previous and active projects.
        Mostly covering bigger projects ranging from site design overhauls and
        full stack node projects.
      </p>
    </div>
    <div class="container margin-auto">
      ...
      <div class="row project">
        <div class="col-md-7 side-text-right">
          ...
          <div>
        <p>
          No RPD in RPS was a quick and simple application used for a local campaign in
          Richmond, Va. This application consisted of a landing page with information
          about the campaign and a form. Users selected their city district, filled
          out the form for their support of the campaign and their email was sent
          to their district's school board rep. It leveraged emailing services
          through SendGrip and Outlook through GoDaddy.
        </p>
          </div>
          </div>
        </div>
