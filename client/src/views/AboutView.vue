      ...
      <div class="row p-5">
        <div class="col-xsmall-12 col-md-8 dir-col circle-bg">
          ...
          <div class="post__content mt-3">
            <p class="mt-3 font-bold">Full-Stack Developer.</p>
            <p class="my-3">
        ...
        >
          ...
          <div class="socials flex">
            ...
            <!-- npm -->
            <a href="https://www.npmjs.com/~jayimbee" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
                width="64px"
            ...
            <!-- resume -->
            <a
              href="https://dev-blog-resources.s3.us-east-1.amazonaws.com/resume/jonah-butler_resume22226.pdf"
